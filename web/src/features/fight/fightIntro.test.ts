...
import { fightIntroSeenKey, introOpensIn, introStartOffset } from "./fightIntroState";

describe("fight intro", () => {
  it("opens its length plus the margin before an upcoming fight starts", () => {
    ...
    // Already inside the lead: open now.
